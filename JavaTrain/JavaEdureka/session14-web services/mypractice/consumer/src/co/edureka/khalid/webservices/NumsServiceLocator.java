...
public class NumsServiceLocator extends org.apache.axis.client.Service implements co.edureka.khalid.webservices.NumsService {
    ...
    public co.edureka.khalid.webservices.Nums getNums(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            co.edureka.khalid.webservices.NumsSoapBindingStub _stub = new co.edureka.khalid.webservices.NumsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (co.edureka.khalid.webservices.Nums.class.isAssignableFrom(serviceEndpointInterface)) {
                co.edureka.khalid.webservices.NumsSoapBindingStub _stub = new co.edureka.khalid.webservices.NumsSoapBindingStub(new java.net.URL(Nums_address), this);
                _stub.setPortName(getNumsWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.khalid.edureka.co", "NumsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.khalid.edureka.co", "Nums"));
        }
